 ...
 */
export declare const useGlobalClicks: <T extends RefObject<ElementType> | undefined | null, ElementType extends Element = Element>(callback: (event: MouseEvent) => void, ...refs: T[]) => void;
